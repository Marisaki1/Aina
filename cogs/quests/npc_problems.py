...
"The Village Blacksmith": [
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Athletics",
                    "text": "Help repair the heavy forge components with your physical strength.)",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Investigation",
                    "text": "Examine the forge to determine the exact cause of the breakdown.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Persuasion",
                    "text": "Convince nearby craftspeople to lend their tools and expertise.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Deception",
                    "text": "Distract the waiting customers with elaborate tales while others fix the forge.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Arcana",
                    "text": "Apply magical knowledge to temporarily enhance the failing forge.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest the blacksmith claim their tools were stolen to explain the delays.",
                ...
                {
                    "text": "Recommend using green, unseasoned wood as emergency forge fuel.",
                ...
                {
                    "text": "Advise doubling prices for the customers who seem most desperate.",
                ...
                {
                    "text": "Suggest using explosives to quickly clear the forge blockage.",
                ...
                {
                    "text": "Propose blaming the forge's breakdown on a competitor's sabotage.",
    ...
    },
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Athletics",
                    "text": "Offer to venture into the mine yourself to retrieve the component.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Persuasion",
                    "text": "Convince local miners to share their knowledge and spare materials.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Insight",
                    "text": "Suggest an alternative, more common material that could be adapted for the same purpose.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Survival",
                    "text": "Scout a safer route into the abandoned section of the mine.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "History",
                    "text": "Research old mining records to locate forgotten deposits of the material.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest stealing the component from a rival blacksmith's supplies.",
                ...
                {
                    "text": "Recommend hiring inexperienced locals for a dangerous mining expedition.",
                ...
                {
                    "text": "Advise using magical illusions to disguise cheaper metals as the rare component.",
                ...
                {
                    "text": "Propose kidnapping a mining expert to force them to help.",
                ...
                {
                    "text": "Suggest claiming the finished products contain the rare metal without actually using it.",
    ...
    },
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Arcana",
                    "text": "Analyze the magical properties to understand the unexpected enchantment.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Investigation",
                    "text": "Examine the forging process to determine exactly what caused the effect.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Persuasion",
                    "text": "Convince the apprentice to demonstrate exactly what they did to recreate the effect.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "History",
                    "text": "Research ancient forging techniques that might explain the magical occurrence.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Performance",
                    "text": "Create a compelling story about the weapon's 'intentional' magical properties to attract buyers.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest hiding the magical effect and selling it as a normal weapon.",
                ...
                {
                    "text": "Recommend smashing the enchanted weapon and melting it down immediately.",
                ...
                {
                    "text": "Advise firing the apprentice for dangerous magical experimentation.",
                ...
                {
                    "text": "Propose charging customers to touch the magical weapon as a good luck charm.",
                ...
                {
                    "text": "Suggest claiming the gods blessed the weapon as a divine sign.",
...
"The Traveling Merchant": [
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Athletics",
                    "text": "Use your strength to help lift the wagon while repairs are made.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Survival",
                    "text": "Find suitable wood in the nearby forest to fashion a temporary replacement wheel.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Sleight of Hand",
                    "text": "Make precise, delicate repairs to the damaged wheel components.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Performance",
                    "text": "Keep watch for bandits while entertaining the merchant during the delay.",
                    "skill_dc": 0,
                ...
                },
                {
                    ...
                    "text": "Calm the merchant's anxious draft animals during the repair process.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest abandoning the heavy merchandise to lighten the wagon's load.",
                ...
                {
                    "text": "Recommend using magical levitation rather than fixing the wheel.",
                ...
                {
                    "text": "Advise continuing to drive on the broken wheel until reaching town.",
                ...
                {
                    "text": "Propose stealing a wheel from another traveler's vehicle.",
                ...
                {
                    "text": "Suggest setting up shop right there on the roadside until help arrives.",
    ...
    },
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Investigation",
                    "text": "Examine the fake to identify where it came from and who created it.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Insight",
                    "text": "Help determine which supplier sold the counterfeit to prevent future fraud.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Arcana",
                    "text": "Detect any magical properties used to disguise the item's true nature.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Deception",
                    "text": "Help create a clever sales pitch to sell the item as an 'authentic reproduction.'",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Persuasion",
                    "text": "Negotiate with the original seller for compensation or replacement.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest selling the counterfeit to an unsuspecting customer at full price.",
                ...
                {
                    "text": "Recommend creating more convincing forgeries to sell alongside authentic items.",
                ...
                {
                    "text": "Advise destroying the fake and denying ever having possessed it.",
                ...
                {
                    "text": "Propose magically enhancing the fake to pass most inspection methods.",
                ...
                {
                    "text": "Suggest threatening the supplier with violence if they don't compensate for the fake.",
    ...
    },
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Performance",
                    "text": "Create an entertaining street performance to draw a crowd of potential customers.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Persuasion",
                    "text": "Convince local shopkeepers to purchase the inventory at wholesale prices.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Deception",
                    "text": "Create a sense of urgency by hinting the items may be banned soon.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Insight",
                    "text": "Identify which items to discount heavily and which will sell regardless.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Investigation",
                    "text": "Research local needs to determine where specific items would be most valuable.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest drastically slashing all prices to sell everything immediately.",
                ...
                {
                    "text": "Recommend starting a rumor that the merchandise is stolen to create excitement.",
                ...
                {
                    "text": "Advise holding a gambling event where purchases come with a chance to win the entire inventory.",
                ...
                {
                    "text": "Propose claiming the items have magical properties they don't actually possess.",
                ...
                {
                    "text": "Suggest hiring local children to aggressively pressure visitors into making purchases.",
...
"The Tavern Keeper": [
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Performance",
                    "text": "Offer to provide special entertainment to draw in festival-goers.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Brewing",
                    "text": "Help create a unique festival drink special that can't be found elsewhere.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Investigation",
                    "text": "Discover why customers are avoiding the tavern specifically.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Persuasion",
                    "text": "Convince festival performers to use the tavern as their official gathering spot.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Deception",
                    "text": "Start an intriguing rumor about a celebrity secretly visiting the tavern tonight.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest watering down drinks to cut costs during the slow period.",
                ...
                {
                    "text": "Recommend physically blocking the entrance to competing establishments.",
                ...
                {
                    "text": "Advise drastically cutting prices to undercut all competition.",
                ...
                {
                    "text": "Propose hiring people to stage exciting bar fights to attract attention.",
                ...
                {
                    "text": "Suggest spreading rumors that other taverns are serving tainted alcohol.",
    ...
    },
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Investigation",
                    "text": "Carefully examine the scene and question patrons who were nearby.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Perception",
                    "text": "Review the evening's events to identify when the theft occurred.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Persuasion",
                    "text": "Appeal to customers' goodwill for information about the theft.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Insight",
                    "text": "Determine which regular customers were acting strangely that evening.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Deception",
                    "text": "Announce a fictional unique property of the heirloom that makes it dangerous to possess.",
                    "skill_dc": 0, 
            ...
            "incorrect": [
                {
                    "text": "Suggest accusing the most suspicious-looking patron without evidence.",
                ...
                {
                    "text": "Recommend hiring a dubious 'curse-caster' to hex the unknown thief. ",
                ...
                {
                    "text": "Advise replacing the heirloom with a replica and pretending nothing happened.",
                ...
                {
                    "text": "Propose randomly searching all customers entering the tavern for the next week.",
                ...
                {
                    "text": "Suggest publicly offering a reward larger than the heirloom's actual value.",
    ...
    },
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Athletics",
                    "text": "Lead an intensive physical cleaning effort of the entire kitchen.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Nature",
                    "text": "Use natural remedies to eliminate pests and odors quickly.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Persuasion",
                    "text": "Convince experienced kitchen staff from other establishments to help with the cleanup.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Alchemy",
                    "text": "Create effective cleaning solutions using available tavern ingredients.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Deception",
                    "text": "Rearrange the kitchen to hide problem areas while highlighting the cleanest sections.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest bribing the health inspector to overlook the violations.",
                ...
                {
                    "text": "Recommend using strong magic to create an illusion of cleanliness.",
                ...
                {
                    "text": "Advise spreading rumors that the inspector is corrupt to discredit their findings.",
                ...
                {
                    "text": "Propose serving the inspector food prepared off-premises while claiming it's from the kitchen.",
                ...
                {
                    "text": "Suggest temporarily closing the kitchen claiming a water leak that needs repair.",
...
"The Town Healer": [
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Nature",
                    "text": "Identify local alternatives that could serve the same medicinal purpose.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Survival",
                    "text": "Lead an expedition to remote areas where the herb might still be growing.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Medicine",
                    "text": "Help develop a new treatment protocol that requires less of the rare herb.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Persuasion",
                    "text": "Organize a town-wide effort to check home gardens for the medicinal plant.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Arcana",
                    "text": "Devise a minor enchantment to enhance the potency of the remaining herbs.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest using a deceptive placebo and telling patients it's real medicine.",
                ...
                {
                    "text": "Recommend dramatically increasing prices to ration the remaining supply.",
                ...
                {
                    "text": "Advise stealing supplies from a neighboring town's healer.",
                ...
                {
                    "text": "Propose using a potentially toxic substitute that looks similar.",
                ...
                {
                    "text": "Suggest claiming that common water blessed with fake rituals has healing properties.",
    ...
    },
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Medicine",
                    "text": "Demonstrate the scientific principles behind the impressive recovery.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Persuasion",
                    "text": "Gather testimonials from other patients who benefited from similar treatments.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Investigation",
                    "text": "Research the patient's case to find natural explanations for their recovery.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Religion",
                    "text": "Involve local religious authorities to verify the recovery was blessed but not forbidden.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Insight",
                    "text": "Identify who started the rumors and why they might target the healer.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest bribing officials to drop the investigation quickly.",
                ...
                {
                    "text": "Recommend threatening accusers with curses to frighten them into silence.",
                ...
                {
                    "text": "Advise claiming the patient was never actually sick to begin with.",
                ...
                {
                    "text": "Propose fleeing town until the controversy dies down.",
                ...
                {
                    "text": "Suggest publicly demonstrating 'more powerful' magic to intimidate accusers.",
    ...
    },
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Medicine",
                    "text": "Analyze the unusual symptoms to determine the true nature of the illness.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "History",
                    "text": "Research old medical texts for records of similar symptom patterns.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Investigation",
                    "text": "Trace the patient's recent activities and contacts to find the illness source.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Nature",
                    "text": "Examine environmental factors that might be causing or worsening the condition.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Persuasion",
                    "text": "Contact healers from other regions who might have encountered this illness.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest using aggressive bloodletting to purge the unknown illness.",
                ...
                {
                    "text": "Recommend using untested, experimental potions out of desperation.",
                ...
                {
                    "text": "Advise telling the patient nothing can be done to prevent panic.",
                ...
                {
                    "text": "Propose using forbidden necromantic magic to fight death at any cost.",
                ...
                {
                    "text": "Suggest isolating the patient in case the unknown illness is demonic possession.",
...
"The Mysterious Fortune Teller": [
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Investigation",
                    "text": "Search the fortune teller's tent for clues about the thief.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Deception",
                    "text": "Help create an impressive alternative divination method before the noble arrives.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Persuasion",
                    "text": "Spread word that returning the crystal will bring good fortune, while keeping it brings a curse.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Arcana",
                    "text": "Create a temporary magical link to the stolen crystal to continue using its power.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Performance",
                    "text": "Help stage a dramatic 'vision' explaining that spirits commanded a change in divination methods.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest using an ordinary glass orb and pretending it's the special crystal.",
                ...
                {
                    "text": "Recommend accusing the noble's servant of stealing the crystal.",
                ...
                {
                    "text": "Advise claiming that the crystal shattered during a particularly dark vision about the noble.",
                ...
                {
                    "text": "Propose using mind-affecting magic to make the noble believe they received a reading.",
                ...
                {
                    "text": "Suggest hiring a local child to claim they saw the noble's rival stealing the crystal.",
    ...
    },
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Persuasion",
                    "text": "Help present the vision with compelling details that distinguish it from past predictions.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Investigation",
                    "text": "Look for current signs that might corroborate elements of the prophesied disaster.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "History",
                    "text": "Research if similar disasters have happened in the region's past.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Insight",
                    "text": "Identify which respected community members would be most receptive to the warning.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Nature",
                    "text": "Analyze natural indicators that might validate the fortune teller's vision.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest creating a fake minor disaster to prove the fortune teller's credibility.",
                ...
                {
                    "text": "Recommend making the prediction increasingly extreme and frightening to force attention.",
                ...
                {
                    "text": "Advise keeping the prediction secret except for the wealthiest citizens who can pay for warning.",
                ...
                {
                    "text": "Propose using illusion magic to show terrifying visions of the disaster to skeptics.",
                ...
                {
                    "text": "Suggest claiming the gods will punish anyone who doesn't heed the warning.",
    ...
    },
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Persuasion",
                    "text": "Help the fortune teller make a sincere public apology for the breach of trust.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Deception",
                    "text": "Create confusion about what was actually revealed by introducing alternative interpretations.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Performance",
                    "text": "Stage a demonstration showing how visions can be easily misinterpreted.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Insight",
                    "text": "Help the fortune teller understand the client's true feelings to make proper amends.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Intimidation",
                    "text": "Convince rumormongers that spreading the secret further will bring misfortune.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest accusing the client of planting the information to create a scandal.",
                ...
                {
                    "text": "Recommend offering free readings to anyone who forgets about the scandal.",
                ...
                {
                    "text": "Advise using minor memory-affecting magic on witnesses to the revelation.",
                ...
                {
                    "text": "Propose spreading equally scandalous rumors about other prominent citizens as distraction.",
                ...
                {
                    "text": "Suggest fleeing town immediately and setting up shop elsewhere under a new identity.",
...
"The Retired Adventurer": [
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Investigation",
                    "text": "Search for clues around the adventurer's home about the thief's identity.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Persuasion",
                    "text": "Ask around town for information about suspicious visitors or recent trophy sales.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Athletics",
                    "text": "Offer to help the adventurer personally track down and confront the thief.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Insight",
                    "text": "Determine who might have both motive and opportunity to steal this specific item.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Survival",
                    "text": "Track the thief through town and into the surrounding wilderness.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest accusing the adventurer's estranged family member without evidence.",
                ...
                {
                    "text": "Recommend claiming the trophy was never stolen but sold to cover gambling debts.",
                ...
                {
                    "text": "Advise hiring a questionable 'curse-caster' to magically punish the unknown thief.",
                ...
                {
                    "text": "Propose breaking into the homes of all suspicious neighbors to search for the trophy.",
                ...
                {
                    "text": "Suggest creating a replica and pretending it was never stolen.",
    ...
    },
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "History",
                    "text": "Research independent accounts that corroborate the adventurer's famous exploits.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Performance",
                    "text": "Help the adventurer tell their stories more convincingly with dramatic flair.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Persuasion",
                    "text": "Find witnesses from the adventurer's past who can verify their accomplishments.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Medicine",
                    "text": "Examine the adventurer's scars and injuries that match their harrowing tales.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Insight",
                    "text": "Help identify which aspects of the tales the bard finds least believable and address them.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest threatening the bard to stop their questioning and leave town.",
                ...
                {
                    "text": "Recommend bribing the bard to write flattering, exaggerated accounts.",
                ...
                {
                    "text": "Advise creating fake 'evidence' like doctored trophies or forged commendations.",
                ...
                {
                    "text": "Propose using magic to make the bard more gullible and accepting of the stories.",
                ...
                {
                    "text": "Suggest staging a fake monster attack for the adventurer to heroically thwart.",
    ...
    },
    {
        ...
        "choices": {
            "correct": [
                {
                    "skill": "Arcana",
                    "text": "Analyze the magical nature of the phenomena to determine their cause.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "History",
                    "text": "Research the ancient evil from historical records to find its weaknesses.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Investigation",
                    "text": "Examine the pattern of strange occurrences for clues about what's happening.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Religion",
                    "text": "Consult with religious authorities about spiritual protections against ancient evils.",
                    "skill_dc": 0,
                ...
                {
                    "skill": "Survival",
                    "text": "Track the supernatural phenomena to their source location.",
                    "skill_dc": 0,
            ...
            "incorrect": [
                {
                    "text": "Suggest ignoring the nightmares and phenomena as mere coincidence.",
                ...
                {
                    "text": "Recommend the adventurer leave town to draw the evil presence away.",
                ...
                {
                    "text": "Advise conducting an amateur exorcism ritual found in an old book.",
                ...
                {
                    "text": "Propose publicly blaming a marginalized town resident for causing the phenomena.",
                ...
                {
                    "text": "Suggest using forbidden magic to fight the ancient evil directly.",
