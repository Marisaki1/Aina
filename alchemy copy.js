...
import { Mountain, Trees, Home, Droplet } from 'lucide-react';
...
const HexGame = () => {
  ...
  const TILE_DATA = {
    ...
    '0,-1': { type: 'plain', color: '#228B22', icon: 'tree', resources: { wood: 3, herbs: 1 } },
    '1,-1': { type: 'plain', color: '#CD853F', icon: 'mountain', resources: { stone: 2, iron: 1 } },
    '1,0': { type: 'plain', color: '#228B22', icon: 'tree', resources: { wood: 3, herbs: 1 } },
    '0,1': { type: 'plain', color: '#228B22', icon: 'tree', resources: { wood: 3, herbs: 1 } },
    '-1,1': { type: 'plain', color: '#CD853F', icon: 'mountain', resources: { stone: 2, iron: 1 } },
    '-1,0': { type: 'plain', color: '#228B22', icon: 'tree', resources: { wood: 3, herbs: 1 } },
    
    // Ring 2
    '0,-2': { type: 'forest', color: '#CD853F', icon: 'mountain', resources: { stone: 2, iron: 1 } },
    '1,-2': { type: 'forest', color: '#4682B4', icon: 'water', resources: { fish: 2, water: 3 } },
    '2,-2': { type: 'forest', color: '#CD853F', icon: 'mountain', resources: { stone: 2, iron: 1 } },
    '2,-1': { type: 'forest', color: '#4682B4', icon: 'water', resources: { fish: 2, water: 3 } },
    '2,0': { type: 'forest', color: '#CD853F', icon: 'mountain', resources: { stone: 2, iron: 1 } },
    '1,1': { type: 'forest', color: '#CD853F', icon: 'mountain', resources: { stone: 2, iron: 1 } },
    '0,2': { type: 'forest', color: '#CD853F', icon: 'mountain', resources: { stone: 2, iron: 1 } },
    '-1,2': { type: 'forest', color: '#4682B4', icon: 'water', resources: { fish: 2, water: 3 } },
    '-2,2': { type: 'forest', color: '#CD853F', icon: 'mountain', resources: { stone: 2, iron: 1 } },
    '-2,1': { type: 'forest', color: '#4682B4', icon: 'water', resources: { fish: 2, water: 3 } },
    ...
    // Ring 3
    '0,-3': { type: 'mountain', color: '#F0E68C', icon: 'plains', resources: { wheat: 2 } },
    '1,-3': { type: 'water', color: '#4682B4', icon: 'water', resources: { fish: 2, water: 3 } },
    '2,-3': { type: 'water', color: '#F0E68C', icon: 'plains', resources: { wheat: 2 } },
    '3,-3': { type: 'mountain', color: '#F0E68C', icon: 'plains', resources: { wheat: 2 } },
    '3,-2': { type: 'water', color: '#F0E68C', icon: 'plains', resources: { wheat: 2 } },
    '3,-1': { type: 'water', color: '#F0E68C', icon: 'plains', resources: { wheat: 2 } },
    '3,0': { type: 'mountain', color: '#F0E68C', icon: 'plains', resources: { wheat: 2 } },
    '2,1': { type: 'water', color: '#F0E68C', icon: 'plains', resources: { wheat: 2 } },
    '1,2': { type: 'water', color: '#F0E68C', icon: 'plains', resources: { wheat: 2 } },
    '0,3': { type: 'mountain', color: '#F0E68C', icon: 'plains', resources: { wheat: 2 } },
    '-1,3': { type: 'water', color: '#4682B4', icon: 'water', resources: { fish: 2, water: 3 } },
    '-2,3': { type: 'water', color: '#F0E68C', icon: 'plains', resources: { wheat: 2 } },
    '-3,3': { type: 'mountain', color: '#F0E68C', icon: 'plains', resources: { wheat: 2 } },
  ...
  const getIcon = (iconType) => {
    switch(iconType) {
      ...
      case 'tree': return <Trees size={16} />;
